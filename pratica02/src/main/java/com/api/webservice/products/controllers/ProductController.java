package com.api.webservice.products.controllers; // Define o pacote onde esta classe está localizada
...
import com.api.webservice.products.model.Product; // Importa a classe Product do pacote model
